...
public class Tradeinformation2 extends AppCompatActivity {
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.information2_rv);
        ...
        if (user != null) {//지금 로그인된 유저가 있다면
            ...
            databaseReference = database.getReference("Trade information"); //DB테이블 연결
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for(DataSnapshot snapshot: dataSnapshot.getChildren()){//반복문으로 데이터 List를 추출해냄
                        ...
                        arrayList1.add(user); //담은 데이터들을 배열리스트에 넣고 리사이클러뷰로 보낼준비
        ...
        adapter=new Tradeinformationadapter2(myList,this);
